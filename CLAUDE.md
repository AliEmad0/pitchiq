...
- **⚠️ The header fits five nav pills plus Game with 0px to spare at 1024px** (88px logo + 537px nav + 342px right-hand cluster). `/compare` moved into "More ▾" to make room for `/game`. Adding another `PRIMARY_NAV_HREFS` entry without removing one overflows the header and scrolls the body sideways — measure before you do.
