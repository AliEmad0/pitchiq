 ...
 */
function clubKey(card: PoolCard): string | null {
 ...
 */
export function linkTier(a: PoolCard, b: PoolCard): LinkTier {
...
function tiers(cards: readonly (PoolCard | null | undefined)[], formation: Formation): LinkTier[] {
...
export function chemistryBreakdown(
  cards: readonly (PoolCard | null | undefined)[],
  formation: Formation,
...
export function chemistry(
  ...
  return Math.round((total / (all.length * MAX_STRENGTH)) * 100);
}
