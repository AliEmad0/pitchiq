...
describe("game routes stay CDN-served", () => {
  ...
  it("finds every game route", () => {
    ...
    // /game/daily (TASK-1817), /game/[mode] (TASK-1810).
    // TASK-1832 retired /game/play — it is a next.config redirect now, not a route.
    // ⚠️ `/game/[mode]` is ONE FILE standing for N prerendered modes, so this counts
    // FILES, not pages — do not "fix" it downward when the pack list grows.
